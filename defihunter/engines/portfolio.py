...
class CorrelationEngine:
    ...
    def calculate_correlation(self, candidate_symbol: str, portfolio_symbols: List[str], timeframe: str = '1h', limit: int = 100) -> dict:
        """
        Calculates correlation matrix and summary stats for a candidate vs existing portfolio.
        """
        if not self.fetcher or not portfolio_symbols:
